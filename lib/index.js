...
var Drip = module.exports = integration('Drip')
  ...
  .ensure(function(_, settings) {
    var projects = 'QsBFMv5VT8 vqd4s1B4dR QKsV14k9Au fyKnQHJgmR U5ISWY97iv'
      + '8HNVCx961K N28ghIbcxu VJoItsvt8u OMXAf05X0Z PtTnJLXNYZ'
    var list = projects.split(' ');
    if (list.indexOf(settings.projectId) !== -1) {
      return this.invalid('project was disallowed to send to drip. see #sev-repulsive-vole');
    }
  })
  .channels(['server'])
  .retries(2);
